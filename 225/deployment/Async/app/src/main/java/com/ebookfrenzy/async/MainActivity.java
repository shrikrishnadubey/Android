...
import static com.ebookfrenzy.async.R.attr.title;

public class MainActivity extends AppCompatActivity {
    String apiUrl = "http://mobileappdatabase.in/demo/" +
            "smartnews/app_dashboard/jsonUrl/" +
            "single-article.php?article-id=71";
    ...
    public class MyAsyncTasks extends AsyncTask<String, String,
            String> {
        @Override
